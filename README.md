...
|              | 공통     | 기능명세서 작성               |                     | 김민지   |               |
|              | 공통     | API 연동 규격서 작성          |                     | 이서연   |               |
|              | 공통     | ERD 작성                      |                    | 박지훈   |               |
|              | 공통     | WBS 작성                      |                    | 전체     |               |
|              | 공통     | Sequence Diagram 작성         |                    | 김수현   |               |
|              | 공통     | 사용자 요구사항 명세서 작성   |                     | 전체     |                |
|              | 공통     | 제공자 요구사항 명세서 작성   |                     | 전체     |                |
|              | FE      | 기술 스택 선정               |                     | 전체      |                |
|              | BE      | 기술 스택 선정                |                     | 전체     |                |
|              | 공통     | Git 커밋 컨벤션 정의          |                     | 전체     |                |
|              | 공통     | Git 브랜치 전략 정의          |                     | 전체     |                |
|              | 공통     | 코드 컨벤션 정의              |                     | 전체     |                |
|              | 공통     | 디자인 concept 정의          |                     | 전체     |                |
|              | FE      | 프로젝트 디렉토리 구조 설정   |                     | 전체     |                |
|              | BE      | 프로젝트 디렉토리 구조 설정   |                     | 전체     |                |
|              | FE      | 프로젝트 생성                |                     | 전체     |                |
|              | BE      | 프로젝트 생성                |                     | 전체     |                |
|              | FE      | 프로젝트 설정                |                     | 전체     |                |
|              | BE      | 프로젝트 설정                |                     | 전체     |                |
